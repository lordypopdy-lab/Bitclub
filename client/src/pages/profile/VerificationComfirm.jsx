  ...
  return (
    <>
      <div className="header fixed-top bg-surface d-flex justify-content-center align-items-center">
        <Link to="/PersonalVerification" className="left back-btn">
        ...
        <div className="tf-container">
          ...
          <ul className="mt-20">
            ...
            <li className="mt-20">
              ...
              <p className="mt-8 text-large text-white">
          ...
          <div className="mt-40">
            <Link to="/VerifyID" className="tf-btn lg primary">
              Confirm
            </Link>
            <Link
              to="/PersonalVerification"
              className="mt-12 tf-btn lg secondary"
            >
              Edit information
            </Link>
          </div>
