          ...
          <div className="accent-box bg-menuDark mt-4">
            ...
            <div className="mt-16 d-flex gap-8 mr--16">
              <p className="text-small text-white d-flex align-items-center gap-6">
                <i className="dot-md bg-secondary"></i> Personal information
              </p>
              <p className="text-small text-white d-flex align-items-center gap-6">
                <i className="dot-md bg-secondary"></i> Verified ID Card
              </p>
            </div>
            <Link to="/ChooseVerification" className="tf-btn xs primary mt-12">
              Verification
            </Link>
          </div>
        </div>
