        ...
        <div className="tf-container">
          ...
          >
            <div className="box-left">
              ...
              {!!user && user.verification == "Unverified" ? (
                <span className=" text-red">{!!user && user.verification}</span>
              ) : !!user && user.verification == "Inreview" ? (
          ...
          >
            ...
            <span className="text-secondary d-flex gap-8 align-items-center">
              Level 1 <i className="icon-arr-right fs-12 text-secondary"></i>
            </span>
          </Link>
          <ul className="mt-16 pb-12 line-bt">
            ...
            <li>
              ...
              >
                ...
                <span className="text-secondary d-flex gap-8 align-items-center">
                  {!!user && user._id}{" "}
                  <i className="icon-copy fs-16 text-secondary"></i>
                </span>
              </Link>
            </li>
            <li>
            ...
            <li>
              ...
              >
                ...
                <span className="text-secondary d-flex gap-12 align-items-center">
                  Add now{" "}
                  <i className="icon-arr-right fs-16 text-secondary"></i>
                </span>
              </Link>
            </li>
            <li>
            ...
            <ul className="mt-20 pb-16">
              <li data-bs-dismiss="modal">
                <div className="d-flex justify-content-between align-items-center gap-8 text-large  item-check active">
                  Take a photo <i className="icon icon-check-circle"></i>{" "}
                </div>
              </li>
