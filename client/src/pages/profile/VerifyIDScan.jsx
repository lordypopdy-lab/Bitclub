    ...
    <>
      ...
      <div className="pt-45 pb-16">
        <div className="tf-container">
          ...
          <Link to="/FaceID" className="tf-btn lg primary mt-40">
            Start
          </Link>
          <p className="mt-12 text-center">
            By clicking "Get Started", I consent to Avicoin's income, processing
            and sharing of my personal information, which may include biometric
            data, as set forth in{" "}
