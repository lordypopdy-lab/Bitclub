  ...
  return (
    <>
      <div className="header fixed-top bg-surface d-flex justify-content-center align-items-center">
        ...
        <h3>QR code</h3>
        <Link to="javascript:void(0);" className="right">
          <i style={{ fontSize: "27px" }} className="icon-exchange p-1"></i>{" "}
          Receive
        </Link>
      </div>
        ...
        <ul className="mt-10 accent-box line-border">
          <li>
            ...
            <InputGroup className="mb-2 mt-3">
              ...
              />
              <InputGroup.Text
                onClick={copyAddrress}
                style={{ border: "none", cursor: "pointer" }}
                className="bg-transparent line-border"
                id="basic-addon1"
              >
                <i
                  style={{ fontSize: "22px" }}
                  className="icon-copy text-light"
                ></i>
              </InputGroup.Text>
            </InputGroup>
          </li>
