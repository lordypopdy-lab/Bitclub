...
const Earn = () => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            const listItems = datas.map((token, index) => {
                return (
                    <li key={index}>
    ...
    const changeFunction = (e) => {
        ...
        const filteredItems = tokens.filter((token) =>
                            ...
                            <div className="swiper-wrapper">
                                <SwiperSlide>
                                    <div className="accent-box-v5 p-0 bg-icon2 bg-menuDark active">
                                        <Link onClick={toContractOne} className="coin-item style-1 gap-12 bg-surface">
                                            <div className="mt-1">
                                                <span className="icon-box bg-transparent bg-icon1"><i className="icon-book"></i></span>
                                                <Link to="#" className="text-small">Contract <span style={{ color: '#25C866' }}>Class One</span></Link>
                                ...
                                <SwiperSlide>
                                    <div className="accent-box-v5 bg-menuDark">
                                        <Link onClick={toContractTwo} className="coin-item style-1 gap-12 bg-surface">
                                            <span className="icon-box bg-transparent bg-icon1"><i className="icon-book"></i></span>
                                            <div className="mt-12">
                                                <Link to="#" className="text-small">Contract <span style={{ color: '#25C866' }}>Class two</span></Link>
                                                <p className="mt-4">Click Create and set up your collection.
