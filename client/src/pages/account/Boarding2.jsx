          ...
          <div className="d-flex flex-column min-vh-100 justify-content-between">
            ...
            <div className="content mb-32">
              <h2 className="text-center">
                A Fantastic Experience with Bitclub!
              </h2>
              <p className="mt-8 text-center text-large">
                Explore the diverse features of Bitclub. Send and receive funds,
                track transaction history, create new wallets, and much
                more.{" "}
              </p>
            ...
            <div className="heading">
              ...
              <div className="mt-4 text-small">
                ...
                <p>
                  ...
                  that mobile app developers stay compliant with state, federal,
                  and international laws. As a result, they fulfill the legal
