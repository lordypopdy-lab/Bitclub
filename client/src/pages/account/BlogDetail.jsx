  ...
  return (
    <>
      ...
      <div className="header absolute">
        <div className="tf-container">
          <div className="d-flex justify-content-between align-items-center mt-12">
            <Link to="/ListBlog" className="box-icon back-btn">
              <i className="icon-left-btn"></i>
            </Link>
            <Link to="#" className="box-icon text-secondary">
      ...
      <div className="wrapper-blog">
        <img src={bannerblog} alt="images" className="banner-blog" />
      </div>
      <div className="pt-16 pb-16">
        <div className="tf-container">
          ...
          <div className="d-flex justify-content-between align-items-center mt-12">
            <ul className="box-user-blog">
              <li className="d-flex align-items-center">
                ...
                &ensp;
                <p>
                  by <span className="text-white">Themesflat</span>
                </p>
              </li>
          ...
          <ul className="d-flex gap-6 mt-12 flex-wrap">
            <li>
              <Link to="#" className="list-item-social">
          ...
          <p className="mt-8 text-large">
            ...
            someone else might be able to open it without you knowing, so losing
            the key effectively means you have lost the wallet and the money it
            holds.
          </p>
        </div>
      </div>
