        ...
        if (trx.status == "Paused") {
          ...
          if (data.success) {
            ...
            if (receipt) {
              ...
              const { data } = await axios.post("/api/getProfitTwo", {
                email,
                amount,
              });
              if (data.success) {
      ...
      <div className="app-wallet">
        <div className="header-style2 fixed-top d-flex align-items-center justify-content-between bg-surface">
          ...
          <i
            ...
            className="icon-clockwise2 text-primary"
          ></i>
        </div>
              ...
              <div className="pt-55">
                <div className="tf-container bg-transparent">
                  <h1 className="mt-8 text-center">
                    ${trx.contractPrice !== null && convertedPrice.toFixed(2)}
                  </h1>
                  <ul className="mt-12 accent-box-v4 bg-menuDark">
                    <li className="d-flex align-items-center justify-content-between pt-8 pb-8 line-bt">
                      ...
                      <h3 className="text-button text-white fw-6 text-end">
                        $
                        {convertedProfit !== null && convertedProfit.toFixed(2)}
                      </h3>
                    </li>
                    <span
                      data-bs-toggle="modal"
                      data-bs-target="#getProfit"
                      style={{
                        marginTop: "-200px",
                        borderRadius: "0",
                        cursor: "pointer",
                      ...
                      className="text-small text-light coin-btn increase"
                    >
                      Get Profit
                    </span>
                    <li className="d-flex align-items-center justify-content-between pt-8 pb-8 line-bt">
              ...
              <div className="tab-content  pb-16">
                ...
                >
                  <ul className="mt-10 accent-box line-border">
                    <h3 className="text-primary">Activation History!</h3>
                    <hr />
                    <li className="trade-list-item">
                      ...
                      <p className="d-flex gap-8 text-white">
                        {trx.contractPrice !== null && trx.contractPrice} ETH ={" "}
                        {trx.contractPrice !== null &&
                          convertedPrice.toFixed(2)}{" "}
                        USDC <i className="icon-clockwise2 fs-16"></i>
                      </p>
                    </li>
                      ...
                      <div className="coin-item style-1 gap-8 mt-20">
                        ...
                        <div className="content">
                          ...
                          <div className="box-price text-end">
                            <h3 className="mb-4">
                              {trx.contractPrice !== null && trx.contractPrice}
                            </h3>
                            <span>
                              $
                              {trx_rate * trx.contractPrice !== null &&
                                trx_rate * trx.contractPrice}
                            </span>
                          </div>
                        </div>
                      </div>
            ...
            <div className="modal-content modal-sm">
              <div className="p-16 line-bt">
                ...
                <p className="mt-12 text-center text-large">
                  Are you sure you want to pause this contract?
                </p>
              </div>
