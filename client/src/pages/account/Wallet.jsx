...
import Market from "../components/WalletComp/Market";
            ...
            <div className="box-detail-chart">
              <div className="top">
                ...
                {details.pricePercentage > 1 ? (
                  <p className="mt-4">
                    <a className="text-primary">{details.pricePercentage}</a>
                    &emsp;Last 24 hours
                  </p>
                ) : (
                  <p className="mt-4">
                    <a className="text-red">{details.pricePercentage}</a>
                    &emsp;Last 24 hours
                  </p>
                )}
              </div>
                ...
                <ul className="mt-16 d-flex gap-16">
                  <li className="flex-1">
                    ...
                    >
                      <div className="content">
                        <p className="text-small">
                          {details.symbol.toLocaleUpperCase()}{" "}
                  ...
                  <li className="flex-1">
                    ...
                    >
                      <div className="content">
                        ...
                        {details.ath_change_percentage > 1 ? (
                          <span className="d-inline-block mt-8 coin-btn increase">
